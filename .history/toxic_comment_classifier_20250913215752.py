...
train_vectors = vectorizer.fit_transform(train_text.apply(stem_text))
val_vectors = vectorizer.transform(val_text.apply(stem_text))
...
test_vectors = vectorizer.transform(test_df_merged['comment_text'].apply(stem_text))

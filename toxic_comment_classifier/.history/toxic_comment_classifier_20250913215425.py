...
# Explicitly removing punctuation
...
train_vectors = vectorizer.fit_transform(train_text.apply(remove_punctuation))
val_vectors = vectorizer.transform(val_text.apply(remove_punctuation))
...
test_vectors = vectorizer.transform(test_df_merged['comment_text'].apply(remove_punctuation))

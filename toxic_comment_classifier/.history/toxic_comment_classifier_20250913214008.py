...
# Get the IDs from the test set to ensure we only use labels for the actual test data
test_ids = test_df['id']
...
# Merge test_df with the filtered and adjusted test_labels_df
# Using 'inner' merge ensures we only keep IDs present in both dataframes,
# and since we filtered test_labels_df by test_ids, this should now align correctly.

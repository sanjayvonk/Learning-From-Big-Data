...
train_vectors = vectorizer.fit_transform(train_text.apply(lemmatize_text))
val_vectors = vectorizer.transform(val_text.apply(lemmatize_text))
...
test_vectors = vectorizer.transform(test_df_merged['comment_text'].apply(lemmatize_text))
